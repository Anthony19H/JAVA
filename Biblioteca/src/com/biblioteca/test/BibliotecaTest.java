...
public class BibliotecaTest {
	...
	public static void main(String[] args) {
		...
		Libro libro1 = new Libro(1,"JJ Benites", "Caballo de Troya", "Aventura", 1997);
		
		Usuario usuario1 = new Usuario("Cynthia", "Cacuango" , "1723879662", 1);
		...
		Libro libro2 = new Libro(2,"George Orwell", "1984", "Politica", 1949);
		...
		Libro libro3 = new Libro(3, "Jane Austen", "Orgullo y Prejuicio", "Romance",1813);
		biblioteca.agregarLibro(libro3);
		System.out.println(biblioteca.getLibros());
		
		Libro libro4 = new Libro(4, "José Saramago", "Ensayo sobre la ceguera", "Novela", 1995);

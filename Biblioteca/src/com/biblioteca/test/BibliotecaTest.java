...
public class BibliotecaTest {
    ...
    public static void main(String[] args) {
        ...
        Libro libro1 = new Libro(1, "JJ Benites", "Harry Potter", "Aventura", 1997, (double)12.0F);
        ...
        System.out.println(usuario1);
        Libro libro3 = new Libro(3, "Jane Austen", "Orgullo y Prejuicio", "Romance", 1813, (double)26.5F);
        biblioteca.agregarLibro(libro3);
        System.out.println(biblioteca.getLibros());
        Libro libro4 = new Libro(4, "José Saramago", "Ensayo sobre la ceguera", "Novela", 1995, (double)80.5F);
        ...
        System.out.println("\n Ejercicio 6 \n");
        biblioteca.buscarPrecioMaximo((double)10.0F);
        System.out.println("\n Ejercicio 7 \n");
        biblioteca.buscarPrecioMinimo((double)90.0F);
    }
}
